...
/*   Updated: 2023/10/24 17:58:02 by taekklee         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
typedef void	(*t_key_press_fn)(void *mlx_ptr, int keycode);
typedef void	(*t_button_press_fn)(void *mlx_ptr, int x, int y);
typedef void	(*t_button_release_fn)(void *mlx_ptr, int x, int y);
