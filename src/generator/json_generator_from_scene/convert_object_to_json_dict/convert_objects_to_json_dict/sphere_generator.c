...
/*   Updated: 2023/12/06 19:30:50 by taekklee         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_vla	*sphere_generator(t_object *object)
{
	...
	append_ppm_reader(json_sphere, object->texture_map, TEXTURE_MAP);
	append_ppm_reader(json_sphere, object->bump_map, BUMP_MAP);
	return (json_sphere);
}
